...
public class RestControlEmploye {
    private static final Logger LOG = LogManager.getLogger(RestControlEmploye.class);
    ...
    public Employe ajouterEmploye(@RequestBody Employe employe) {
        LOG.info("Start Method ajouterEmploye");
        LOG.info("End Method ajouterEmploye");
    ...
    public void desaffecterEmployeDuDepartement(@PathVariable("idemp") int employeId, @PathVariable("iddept") int depId) {
        LOG.info("Start Method desaffecterEmployeDuDepartement");
        LOG.info("End Method desaffecterEmployeDuDepartement");
